            ...
            <div className="w-full md:w-[400px] md:rounded-lg bg-gray-50 p-6">
                ...
                <div className="flex gap-x-2">
                    ...
                    <label className="flex-1 relative group block cursor-pointer">
                        ...
                        <span className="absolute top-0 left-0 h-full px-4 flex items-center text-sm text-gray-500 transition-all peer-focus:h-7 peer-valid:text-primary-brand-color peer-focus:text-xs " >Telefon Numarası</span>
                    </label>
                ...
                <button className="bg-blue-900 bg-opacity-10 text-blue-700 px-4 text-opacity-80 transition-colors hover:bg-blue-700 hover:text-white h-12 flex items-center rounded-md w-full text-sm font-semibold ">
                    <FaFacebook size={24} />
